...
import Pricing01 from "@/components/ui/shadcnui/pricing-01";
import {
  ArrowUpRightIcon,
  CirclePlayIcon,
  DribbbleIcon,
...
export default async function Index() {
  return (
    <main>
        ...
        <div className="max-w-screen-xl w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 py-12 lg:py-0">
          <div className="my-auto">
            ...
            <p className="mt-6 max-w-[60ch] text-lg">
              Tazakkar makes Quran learning exciting and stress-free for
              children. With colorful lessons, interactive activities, and
              caring teachers, we help kids love and connect with the Quran from
              an early age.
            </p>
            <div className="mt-12 flex items-center gap-4">
              <Button size="lg" className="rounded-full text-base bg-lime-500">
          ...
          <Image
            ...
            height={1000}
            width={1000}
            className="w-full aspect-video lg:aspect-auto lg:w-[1000px] lg:h-[calc(100vh-4rem)] bg-slate-100 rounded-xl"
          />
        </div>
      </div>
      ...
      <div className="bg-lime-100 w-full flex flex-col gap-10 items-center justify-center px-6 py-16">
        <div className="text-center max-w-2xl">
          <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-bold !leading-[1.2] tracking-tight">
            A Gift for Every Child: Free Quran Classes
          </h1>
          <p className="mt-6 text-[17px] md:text-lg">
            As Muslims, we believe everyone deserves access to the Quran. That’s
            why Tazakkar offers <b>free Quran classes</b>, as part of our
            mission to teach and spread Quranic knowledge. For families seeking
            a more personalized and interactive learning journey, we also offer
            premium classes with expert teachers, engaging materials, and
